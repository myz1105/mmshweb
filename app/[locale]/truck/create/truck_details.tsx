...
const CreateTruckDetails: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl flex flex-col justify-start items-start gap-3 p-4">
      ...
      <div>
        <h2 className="text-xl text-default-600 dark:text-default-400">
          Body, L x W x H
        </h2>
      ...
      <div className="my-2">
        <div>
          <h1 className="text-xl text-default-600 dark:text-default-400">
            Additional
          </h1>
        </div>
        ...
        {adrIsVisible ? (
          ...
          <div>
            <button
              onClick={() => setADRIsVisible(true)}
              className="m-2 border-none bg-transparent hover:bg-transparent"
            >
              <div className="flex flex-row gap-1">
                <h3 className="text-md text-default-600 dark:text-default-400">
                  ADR
                </h3>
                <Icon className="mt-1" icon="meteor-icons:xmark" />
              </div>
            </button>
            <div className="p-2 text-sm text-default-600 dark:text-default-400">
              <CheckboxGroup
                ...
                className="p-2"
              >
                <Checkbox value="Explosives">
                  <div className="flex flex-row gap-2">
                    ADR 1{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                      Explosives
                    </h4>
                  </div>
                </Checkbox>
                <Checkbox value="Compressed gases">
                  <div className="flex flex-row gap-2">
                    ADR 2{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                      Compressed gases
                ...
                <Checkbox value="Flammable liquids">
                  <div className="flex flex-row gap-2">
                    ADR 3{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                      Flammable liquids
              ...
              <CheckboxGroup
                ...
                className="p-2"
              >
                <Checkbox value="Light-duty thing">
                  <div className="flex flex-row gap-2">
                    ADR 4{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                      Light-duty thing
                ...
                <Checkbox value="Oxidising substances">
                  <div className="flex flex-row gap-2">
                    ADR 5{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                ...
                <Checkbox value="Toxic substances">
                  <div className="flex flex-row gap-2">
                    ADR 6{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                      Toxic substances
              ...
              <CheckboxGroup
                ...
                className="p-2"
              >
                <Checkbox value="Radioactive material">
                  <div className="flex flex-row gap-2">
                    ADR 7{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
                ...
                <Checkbox value="Corrosive substances">
                  <div className="flex flex-row gap-2">
                    ADR 8{" "}
                    <h4 className="text-sm text-default-600 dark:text-default-400">
          ...
          <div>
            ...
            <div className="p-2 text-sm text-default-600 dark:text-default-400">
              ...
              >
                ...
                <Checkbox value="Corrosive substances" className="ml-2">
                  EKMT
                </Checkbox>
              </CheckboxGroup>
            </div>
      ...
      <div>
        ...
        <Checkbox size="sm" className="m-1">
          Provide the customer with GPS monitoring service
        </Checkbox>
      </div>
      {/* GPS monitoring */}
      {/* Loading time */}
      <div>
        ...
        <div className="flex flex-row gap-2 mt-2 p-2">
          <Dropdown>
            ...
            >
              <DropdownItem key="Ready to download">
                Ready to download
              </DropdownItem>
          ...
          <div className="flex flex-col">
            <Button
              ...
              variant="bordered"
              onPress={() => setCalendarIsOpen((prev) => !prev)}
            >
