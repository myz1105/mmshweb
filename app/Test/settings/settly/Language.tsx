...
import { Button, Listbox, ListboxItem, ListboxSection, Selection } from "@heroui/react";
      ...
      <div className="w-full">
        ...
        <ListboxWrapper>
          ...
          >
            ...
            <ListboxItem key="english" showDivider
             className="py-2"
             startContent={<Icon icon="circle-flags:us-um" fontSize={24}/>}
             >English</ListboxItem>
            <ListboxItem key="russian" showDivider className="py-2"
            startContent={<Icon icon="circle-flags:lang-ru" fontSize={24}/>}>Russian</ListboxItem>
            <ListboxItem key="uzbek" showDivider className="py-2"
