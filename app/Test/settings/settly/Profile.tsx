...
export default function ProfileSettings() {
  ...
  return (
    <div className="flex flex-col gap-6 mb-10">
      <div><h2 className="text-lg font-semibold">Profile</h2>
