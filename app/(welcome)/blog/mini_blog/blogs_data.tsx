const posts = [
  {
    ...
    description:
      "Discover strategies to enhance your sales and build a loyal customer base.",
  ...
  },
  {
    ...
    description:
      "Learn how to budget, invest, and save efficiently for long-term success.",
    author: "Emily Carter",
  ...
  },
  {
    ...
    description:
      "How to maintain mental well-being while managing work stress and productivity.",
    author: "Jessica Lee",
    role: "HR Specialist",
  ...
  },
  {
    ...
    description:
      "Understanding the impact of e-learning and its future in modern education.",
  ...
  },
  {
    ...
    description:
      "Discover the best travel spots for remote workers seeking productivity and adventure.",
  ...
  },
  {
    ...
    description:
      "Step-by-step guide to launching a successful startup from scratch.",
    author: "Michael Chen",
  ...
  },
  {
    ...
    description:
      "Uncover the secrets of space, black holes, and quantum physics.",
  ...
  },
  {
    ...
    description:
      "Tracing the journey of pop music from the 60s to the present.",
    author: "David White",
